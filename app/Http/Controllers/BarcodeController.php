    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    'action',
                    '<a href="{{action(\'App\Http\Controllers\BarcodeController@edit\', [$id])}}" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-primary"><i class="fa fa-edit"></i> @lang("messages.edit")</a>
                        &nbsp;
                        <button type="button" data-href="{{action(\'App\Http\Controllers\BarcodeController@destroy\', [$id])}}" class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error delete_barcode_button" @if($is_default) disabled @endif><i class="fa fa-trash"></i> @lang("messages.delete")</button>&nbsp;
                        @if($is_default)
                        ...
                        @else
                            <button class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-info set_default" data-href="{{action(\'App\Http\Controllers\BarcodeController@setDefault\', [$id])}}"><i class="fa fa-check-square" aria-hidden="true"></i> @lang("barcode.set_as_default")</button>
                        @endif
                        '
                )
