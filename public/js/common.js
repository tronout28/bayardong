...
$(document).ready(function () {
    ...
    var buttons = [
        //{
        //    extend: 'copy',
        //    text: '<i class="fa fa-copy" aria-hidden="true"></i> ' + LANG.copy,
        //    className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-warning',
        //    exportOptions: {
        //        columns: ':visible',
        //    },
        //    footer: true,
        //},
        {
            ...
            className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-primary',
            exportOptions: {
                columns: ':visible',
                stripHtml: true,
            },
        ...
        },
        {
            ...
            className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-info',
        },
        {
            extend: 'csv',
            text: '<i class="fa fa-file-csv" aria-hidden="true"></i> ' + LANG.export_to_csv,
            className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-secondary',
            exportOptions: {
                columns: ':visible',
            },
            footer: true,
        },
        {
            ...
            className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-success',
            exportOptions: {
                columns: ':visible',
            },
            footer: true,
    ...
    var pdf_btn = {
        ...
        className: 'tw-dw-btn-xs tw-dw-btn tw-dw-btn-outline tw-dw-btn-error',
        exportOptions: {
            columns: ':visible',
        },
        footer: true,
    ...
    jQuery.extend($.fn.dataTable.defaults, {
        ...
        //stateSave: true,
        fixedHeader: true,
        dom: '<"row margin-bottom-20 text-left"<"col-sm-2"f><"col-sm-2"l><"col-sm-8"B> r>tip',
        buttons: buttons,
        aLengthMenu: [
	...
	//Set select length class in Datatable to select2
...
ranges[LANG.all] = [moment().startOf('year').subtract(100, 'year'), moment()];
var dateRangeSettings = {
	...
	Highcharts.setOptions({
		lang: {
			viewFullscreen: LANG.viewFullscreen,
			exitFullscreen: LANG.exitFullscreen,
			printChart: LANG.printChart,
			downloadPNG: LANG.download + ' PNG',
			downloadJPEG: LANG.download + ' JPEG',
			downloadPDF: LANG.download + ' PDF',
			downloadSVG: LANG.download + ' SVG',
			contextButtonTitle: LANG.contextButtonTitle,
			loading: LANG.loading + ' ...',
			decimalPoint: __decimal_separator,
			thousandsSep: __thousand_separator
		}
	});
