            ...
            <div class="col-md-4 contact_type_div">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('type', $types, $type , ['class' => 'form-control select2', 'id' => 'contact_type','placeholder' => __('messages.please_select'), 'required']); !!}
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      {!! Form::select('customer_group_id', $customer_groups, '', ['class' => 'form-control select2']); !!}
                  </div>
                </div>
            </div>
                ...
                <div class="col-md-4 pay_term">
                  <div class="form-group">
                    <div class="multi-input">
                      ...
                      <br/>
                      {!! Form::number('pay_term_number', null, ['class' => 'form-control width-60 pull-left', 'placeholder' => __('contact.pay_term')]); !!}

                      {!! Form::select('pay_term_type', ['months' => __('lang_v1.months'), 'days' => __('lang_v1.days')], '', ['class' => 'form-control select2 width-40 pull-left','placeholder' => __('messages.please_select')]); !!}
                    </div>
                  </div>
                </div>
                <div class="clearfix"></div>
