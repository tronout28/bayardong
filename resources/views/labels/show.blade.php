				...
				<table class="table table-bordered">
					<tr>
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[name]" value="1" class="input-icheck"> <b>@lang( 'barcode.print_name' )</b>
							    </label>
							</div>
						...
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[variations]" value="1" class="input-icheck"> <b>@lang( 'barcode.print_variations' )</b>
							    </label>
							</div>
						...
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[price]" value="1" id="is_show_price" class="input-icheck"> <b>@lang( 'barcode.print_price' )</b>
							    </label>
							</div>
							...
							<div class="" id="price_type_div">
								<div class="form-group">
									...
									<div class="input-group">
										...
										{!! Form::select('print[price_type]', ['inclusive' => __('product.inc_of_tax'), 'exclusive' => __('product.exc_of_tax')], 'inclusive', ['class' => 'form-control select2']); !!}
									</div>
								</div>
							</div>
					...
					<tr>
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[business_name]" value="1" class="input-icheck"> <b>@lang( 'barcode.print_business_name' )</b>
							    </label>
							</div>
						...
						<td>
							<div class="checkbox">
							    <label>
							    	<input type="checkbox" checked name="print[packing_date]" value="1" class="input-icheck"> <b>@lang( 'lang_v1.print_packing_date' )</b>
							    </label>
							</div>
						...
						<td>
							@if(request()->session()->get('business.enable_lot_number') == 1)
								...
								<div class="checkbox">
								    <label>
								    	<input type="checkbox" checked name="print[lot_number]" value="1" class="input-icheck"> <b>@lang( 'lang_v1.print_lot_number' )</b>
								    </label>
								</div>
						...
						<td>
							@if(request()->session()->get('business.enable_product_expiry') == 1)
								<div class="checkbox">
								    <label>
								    	<input type="checkbox" checked name="print[exp_date]" value="1" class="input-icheck"> <b>@lang( 'lang_v1.print_exp_date' )</b>
								    </label>
								</div>
						...
						@foreach($product_custom_fields as $index => $cf)
							@if(!empty($cf))
								...
								<td>
									<div class="checkbox">
										<label>
											<input type="checkbox" name="print[{{ $field_name }}]" value="1" class="input-icheck"> <b>{{ $cf }}</b>
										</label>
									</div>
			...
			<div class="col-sm-6">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::select('barcode_setting', $barcode_settings, !empty($default) ? $default->id : null, ['class' => 'form-control select2']); !!}
					</div>
				</div>
			</div>
