        ...
        <div class="col-sm-12">
            ...
            <div class="text-center">
                <div class="btn-group">
                    ...
                    <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="tw-dw-btn tw-dw-btn-success tw-dw-btn-lg tw-text-white submit_product_form">@lang('lang_v1.save_n_add_opening_stock')</button>
                    @endcan

                    <button type="submit" value="save_n_add_another" class="tw-dw-btn tw-dw-btn-error tw-dw-btn-lg tw-text-white submit_product_form">@lang('lang_v1.save_n_add_another')</button>
