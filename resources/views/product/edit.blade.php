        ...
        <div class="col-sm-12">
          <div class="text-center">
            <div class="btn-group">
              ...
              <button type="submit" @if(empty($product->enable_stock)) disabled="true" @endif id="opening_stock_button"  value="update_n_edit_opening_stock" class="tw-dw-btn tw-dw-btn-success tw-dw-btn-lg tw-text-white submit_product_form">@lang('lang_v1.update_n_edit_opening_stock')</button>
              @endif

              <button type="submit" value="save_n_add_another" class="tw-dw-btn tw-dw-btn-error tw-dw-btn-lg tw-text-white submit_product_form">@lang('lang_v1.update_n_add_another')</button>
