		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					{!! Form::text('ref_no', null, ['class' => 'form-control', 'placeholder' => __('lang_v1.leave_empty_to_autogenerate')]); !!}
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
			...
			<div class="col-md-3">
		          <div class="form-group">
		            <div class="multi-input">
		              ...
		              <br/>
		              {!! Form::number('pay_term_number', null, ['class' => 'form-control width-60 pull-left', 'min' => 0, 'placeholder' => __('contact.pay_term')]); !!}
			...
			<div class="col-sm-8">
				<div class="form-group">
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button type="button" class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action([\App\Http\Controllers\ProductController::class, 'quickAdd'])}}" data-container=".quick_add_product_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
						</span>
					</div>
				</div>
			</div>
