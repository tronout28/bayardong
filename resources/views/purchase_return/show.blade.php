    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6 col-xs-6">
            ...
            <strong>@lang('purchase.supplier'):</strong> {{$purchase->contact->full_name_with_business}} <br>
          ...
          <table class="table bg-gray">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td><span class="display_currency no-print" data-currency_symbol="true">{{ $purchase_line->purchase_price_inc_tax }}</span><span class="display_currency print_section">{{ $purchase_line->purchase_price_inc_tax }}</span></td>
                  <td>
                    @php
                      $line_total = $purchase_line->purchase_price_inc_tax * $purchase_line->quantity_returned;
                      $total_before_tax += $line_total ;
                    @endphp
                    <span class="display_currency no-print" data-currency_symbol="true">{{$line_total}}</span><span class="display_currency print_section">{{$line_total}}</span>
                  </td>
              </tr>
              @endforeach
            </tbody>
