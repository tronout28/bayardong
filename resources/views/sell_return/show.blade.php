...
<div class="modal-body">
   <div class="row">
      <div class="col-sm-6 col-xs-6">
        ...
        <strong>@lang('contact.customer'):</strong> {{ $sell->contact->full_name_with_business }} <br>
    ...
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        ...
        <tr>
          ...
          <td class="text-right"><span class="display_currency pull-right" data-currency_symbol="true">{{ $total_discount }}</span></td>
        </tr>
...
<div class="modal-footer">
    <a href="#" class="print-invoice tw-dw-btn tw-dw-btn-primary tw-text-white hover:tw-text-white" data-href="{{action([\App\Http\Controllers\SellReturnController::class, 'printInvoice'], [$sell->return_parent->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print")</a>
