<div class="modal-dialog" role="document">
  <div class="modal-content">
    <?php echo Form::open(['url' => action([\Modules\Essentials\Http\Controllers\ToDoController::class, 'store']), 'id' => 'task_form', 'method' => 'post']); ?>
	    	...
	    	<div class="col-md-12">
	        	<div class="form-group">
                    <label for="media_upload">
                        <?php echo app('translator')->get('lang_v1.upload_documents'); ?>:
                    </label>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/Essentials/Providers/../Resources/views/todo/create.blade.php ENDPATH**/ ?>