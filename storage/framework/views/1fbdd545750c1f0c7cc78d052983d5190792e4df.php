      			...
      			<div class="col-md-4">
      				<div class="thumbnail">
      					...
      					<?php if($product->type == 'single' && !empty($discounts[$product->variations->first()->id])): ?>
      						<span class="label label-warning discount-badge">- <?php echo e(number_format($discounts[$product->variations->first()->id]->discount_amount, session('business.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>%</span>
      					<?php endif; ?>
      				</div>
      			</div>
      			<div class="col-md-8">
...
<?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/ProductCatalogue/Providers/../Resources/views/catalogue/show.blade.php ENDPATH**/ ?>