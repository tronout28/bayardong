...
<section class="content-header no-print">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get( 'lang_v1.shipments'); ?>
    </h1>
</section>
    ...
    <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <?php echo Form::select('delivery_person', $delevery_person, null, ['class' => 'form-control select2', 'style' => 'width:100%']); ?>
                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('lang_v1.delivery_person'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/sell/shipments.blade.php ENDPATH**/ ?>