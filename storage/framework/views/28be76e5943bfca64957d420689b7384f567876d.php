<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <?php echo Form::open(['url' => action([\App\Http\Controllers\InvoiceSchemeController::class, 'store']), 'method' => 'post', 'id' => 'invoice_scheme_add_form' ]); ?>


        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title"><?php echo app('translator')->get( 'invoice.add_invoice' ); ?></h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                ?>
                        <?php echo Form::select('number_type', $number_types, null, ['class' => 'form-control select2', 'id' => 'invoice_number_type']); ?>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <?php echo Form::checkbox('is_default', 1); ?> <?php echo app('translator')->get('barcode.set_as_default'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    </div><!-- /.modal-dialog --><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/invoice_scheme/create.blade.php ENDPATH**/ ?>