			...
			<div class="col-md-4 col-sm-6">
		        <div class="form-group">
		        	...
		        	<div class="input-group">
		               <?php echo Form::number('recur_interval', !empty($expense->recur_interval) ? $expense->recur_interval : null, ['class' => 'form-control', 'style' => 'width: 50%; z-index: 0;']); ?>

		               
		                <?php echo Form::select('recur_interval_type', ['days' => __('lang_v1.days'), 'months' => __('lang_v1.months'), 'years' => __('lang_v1.years')], !empty($expense->recur_interval_type) ? $expense->recur_interval_type : 'days', ['class' => 'form-control', 'style' => 'width: 50%;z-index: 0;', 'id' => 'recur_interval_type']); ?>
...
</div><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/expense/recur_expense_form_part.blade.php ENDPATH**/ ?>