...
<section class="content">
	...
	<div class="box-footer">
		<?php echo Form::open(['url' => action([\Modules\Essentials\Http\Controllers\EssentialsMessageController::class, 'store']), 'method' => 'post', 'id' => 'add_essentials_msg_form']); ?>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('form#add_essentials_msg_form').submit(function(e) {
			...
			if(msg) {
				...
				ladda.start();
				$.ajax({
					url: "<?php echo e(action([\Modules\Essentials\Http\Controllers\EssentialsMessageController::class, 'store']), false); ?>",
					data: data,
					method: 'post',
					dataType: "json",
	...
	function getNewMessages() {
		...
		$.ajax({
            url: "<?php echo e(action([\Modules\Essentials\Http\Controllers\EssentialsMessageController::class, 'getNewMessages']), false); ?>?last_chat_time=" + last_chat_time,
            dataType: 'html',
            global: false,
            success: function(result) {
            	if(result.trim() != ''){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/Essentials/Providers/../Resources/views/messages/index.blade.php ENDPATH**/ ?>