...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('invoice.add_invoice_layout'); ?></h1>
</section>

<!-- Main content -->
<section class="content">
<?php echo Form::open(['url' => action([\App\Http\Controllers\InvoiceLayoutController::class, 'store']), 'method' => 'post', 'id' => 'add_invoice_layout_form', 'files' => true]); ?>
      ...
      <div class="row">
        ...
        <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <label>
                        <?php echo Form::checkbox('show_letter_head', 1, false, 
                            ['class' => 'input-icheck', 'id' => 'show_letter_head']); ?> <?php echo app('translator')->get('lang_v1.show_letter_head'); ?></label>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 letter_head_input hide">
                <div class="form-group">
                    ...
                    <span class="help-block"><?php echo app('translator')->get('lang_v1.letter_head_help'); ?> <br> <?php echo app('translator')->get('lang_v1.invoice_logo_help', ['max_size' => '1 MB']); ?></span>
                </div>
            </div>
        <div class="clearfix"></div>
        ...
        <div class="col-sm-6 hide-for-letterhead">
          <div class="form-group">
            ...
            <span class="help-block"><?php echo app('translator')->get('lang_v1.invoice_logo_help', ['max_size' => '1 MB']); ?></span>
          </div>
        </div>
        <div class="col-sm-6 hide-for-letterhead">
          <div class="form-group">
  ...
  <div class="box-body">
    <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::text('common_settings[sales_order_heading]', __('lang_v1.sales_order'), ['class' => 'form-control',
      ...
      ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[sell_custom_fields1]', 1, false, ['class' => 'input-icheck']); ?> <?php echo e($custom_labels['sell']['custom_field_1'] ?? __('lang_v1.product_custom_field1'), false); ?></label>
            </div>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[sell_custom_fields2]', 1, false, ['class' => 'input-icheck']); ?> <?php echo e($custom_labels['sell']['custom_field_2'] ?? __('lang_v1.product_custom_field2'), false); ?></label>
            </div>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[sell_custom_fields3]', 1, false, ['class' => 'input-icheck']); ?> <?php echo e($custom_labels['sell']['custom_field_3'] ?? __('lang_v1.product_custom_field3'), false); ?></label>
            </div>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[sell_custom_fields4]', 1, false, ['class' => 'input-icheck']); ?> <?php echo e($custom_labels['sell']['custom_field_4'] ?? __('lang_v1.product_custom_field4'), false); ?></label>
            </div>
          </div>
        </div>
        <?php endif; ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_commission_agent', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('lang_v1.show_commission_agent'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
    ...
    <div class="row hide-for-letterhead">
      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-12">
          <h4><?php echo app('translator')->get('invoice.fields_to_shown_for_tax'); ?>:</h4>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_1', 1, true, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('invoice.show_tax_1'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_2', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('invoice.show_tax_2'); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::text('common_settings[discounted_unit_price_label]', 'Price after discount', ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_product_description]', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('lang_v1.show_product_description'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
      ...
      <div class="clearfix"></div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_base_unit_details]', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('lang_v1.show_base_unit_details'); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::text('common_settings[tax_summary_label]', '', ['class' => 'form-control', 'placeholder' => __('lang_v1.tax_summary_label'), 'id' => 'tax_summary_label' ]); ?>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                <?php echo Form::checkbox('common_settings[show_qr_code_label]', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('lang_v1.show_labels'); ?></label>
            </div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <div class="checkbox">
                <label>
                <?php echo Form::checkbox('common_settings[zatca_qr]', 1, false, ['class' => 'input-icheck']); ?> <?php echo app('translator')->get('lang_v1.zatca_qr'); ?></label>
                <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/invoice_layout/create.blade.php ENDPATH**/ ?>