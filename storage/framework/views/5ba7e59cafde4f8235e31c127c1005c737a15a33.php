<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="submit_quick_product"><?php echo app('translator')->get( 'messages.save' ); ?></button>
...
</script><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/product/partials/quick_add_product.blade.php ENDPATH**/ ?>