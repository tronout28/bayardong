        ...
        .autocomplete({
            ...
            response: function (event, ui) {
                ...
                if(ui.content[0]?.NotFound ==  true){
                    ...
                    return toastr.error("<?php echo app('translator')->get('inventorymanagement::inventory.product_notfound'); ?>");
//  ("");
                }
...
if(amountAfterInventoryFlag){
    toastr.error("<?php echo app('translator')->get('inventorymanagement::inventory.check_qty_added_msg'); ?>");
}
else{
...
$(document).on('click','#save_new_inv_qty',function (e){
    ...
    if($qty !=  qty_inv){
        swal({
            title: `"<?php echo app('translator')->get('inventorymanagement::inventory.alert_modal_msg'); ?>" : (${$qty})`,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
...
</script><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/InventoryManagement/Providers/../Resources/views/partials/mainscript.blade.php ENDPATH**/ ?>