  ...
  ?>
    ...
    <div class="modal-body">
        <div class="row">            
            <div class="col-md-4 contact_type_div">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <?php echo Form::select('type', $types, $type , ['class' => 'form-control select2', 'id' => 'contact_type','placeholder' => __('messages.please_select'), 'required']); ?>
            ...
            <div class="col-md-4 customer_fields">
                <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <?php echo Form::select('customer_group_id', $customer_groups, '', ['class' => 'form-control select2']); ?>
            ...
            <div class="col-md-9 individual" style="display: none;">
                <div class="form-group">
        ...
        <div class="row">
            ...
            <div id="more_div" class="hide">
                ...
                ?>
                      <br/>
                      <?php echo Form::number('pay_term_number', null, ['class' => 'form-control width-60 pull-left', 'placeholder' => __('contact.pay_term')]); ?>


                      <?php echo Form::select('pay_term_type', ['months' => __('lang_v1.months'), 'days' => __('lang_v1.days')], '', ['class' => 'form-control select2 width-40 pull-left','placeholder' => __('messages.please_select')]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/contact/create.blade.php ENDPATH**/ ?>