...
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo e($title, false); ?> <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">(<?php if($transaction->type == 'sales_order'): ?> <?php echo app('translator')->get('restaurant.order_no'); ?> <?php else: ?> <?php echo app('translator')->get('sale.invoice_no'); ?> <?php endif; ?>: <span class="text-success">#<?php echo e($transaction->invoice_no, false); ?>)</span></small></h1>
</section>
<!-- Main content -->
...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method, false); ?>">
		...
		<div class="col-md-12 col-sm-12">
			<?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<?php echo Form::text('invoice_no', $transaction->invoice_no, ['class' => 'form-control', 'required']); ?>
                ...
                ?>
		              <br/>
		              <?php echo Form::number('pay_term_number', $transaction->pay_term_number, ['class' => 'form-control width-60 pull-left', 'min' => 0, 'placeholder' => __('contact.pay_term'), 'required' => $is_pay_term_required]); ?>
				...
				<div class="col-md-4 <?php if($transaction->type == 'sales_order'): ?> hide <?php endif; ?>">
			        <div class="form-group">
			            ...
			            <div class="input-group">
			                ...
			                <?php echo Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $transaction->discount_type , ['class' => 'form-control select2','placeholder' => __('messages.please_select'), 'required', 'data-default' => 'percentage']); ?>
			    ...
			    <div class="col-md-4 <?php if($transaction->type == 'sales_order'): ?> hide <?php endif; ?>">
			    	<div class="form-group">
			            ...
			            <div class="input-group">
			                ...
			                <?php echo Form::select('tax_rate_id', $taxes['tax_rates'], $transaction->tax_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'data-default'=> $business_details->default_sales_tax], $taxes['attributes']); ?>
			...
			<div class="col-md-4">
				<div class="form-group">
		            ...
		            <?php echo Form::select('shipping_status',$shipping_statuses, $transaction->shipping_status, ['class' => 'form-control select2','placeholder' => __('messages.please_select')]); ?>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<?php echo Form::select('delivery_person', $users, $transaction->delivery_person, ['class' => 'form-control select2','placeholder' => __('messages.please_select')]); ?>
			...
			<?php $__env->startComponent('components.widget', ['class' => 'box-solid', 'title' => __('purchase.add_payment')]); ?>
                ...
                ?>
							<div class="input-group">
								...
								<?php echo Form::select("prefer_payment_method", $payment_types, $transaction->prefer_payment_method, ['class' => 'form-control select2','style' => 'width:100%;']); ?>
                ...
                ?>
							<div class="input-group">
								...
								<?php echo Form::select("prefer_payment_account", $accounts, $transaction->prefer_payment_account, ['class' => 'form-control select2','style' => 'width:100%;']); ?>
	...
	<div class="row">
		<div class="col-md-12 text-center">
	    	...
	    	<button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-lg" id="submit-sell"><?php echo app('translator')->get('messages.update'); ?></button>
	    	<button type="button" id="save-and-print" class="tw-dw-btn tw-dw-btn-success tw-text-white tw-dw-btn-lg"><?php echo app('translator')->get('lang_v1.update_and_print'); ?></button>
	    </div>
	</div>
	<?php if(in_array('subscription', $enabled_modules)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/sell/edit.blade.php ENDPATH**/ ?>