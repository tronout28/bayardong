        ...
        <div class="row">
            <div class="col-md-12">
                <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
							<?php echo Form::label('active_state', __('sale.status') . ':'); ?>
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
            if ($(e.target).attr('href') == '#product_stock_report') {
                if (!data_table_initailized) {
					...
					// hero70411 - fix loi hien thi custom fields
                    stock_report_cols.push({
                        data: 'product_custom_field1',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/product/index.blade.php ENDPATH**/ ?>