      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  <?php echo Form::select('type', $types, $contact->type, ['class' => 'form-control select2', 'id' => 'contact_type','placeholder' => __('messages.please_select'), 'required']); ?>
        ...
        <div class="col-md-4 mt-15">
            <label class="radio-inline">
                <input type="radio" name="contact_type_radio" id="inlineRadio1" value="individual" <?php if($contact->contact_type == 'individual'): ?> checked <?php endif; ?>>
                <?php echo app('translator')->get('lang_v1.individual'); ?>
            </label>
            <label class="radio-inline">
                <input type="radio" name="contact_type_radio" id="inlineRadio2" value="business" <?php if($contact->contact_type == 'business'): ?> checked <?php endif; ?>>
        ...
        <div class="col-md-4 customer_fields">
          <div class="form-group">
              ...
              <div class="input-group">
                  ...
                  <?php echo Form::select('customer_group_id', $customer_groups, $contact->customer_group_id, ['class' => 'form-control select2']); ?>

              </div>
          </div>
        </div>
        <div class="clearfix customer_fields"></div>
        <div class="col-md-4 business" <?php if($contact->contact_type == 'individual' || empty($contact->contact_type)): ?> style="display: none;"  <?php endif; ?>>
          <div class="form-group">
        ...
        <div class="col-md-3 individual"  <?php if($contact->contact_type == 'business' || empty($contact->contact_type)): ?> style="display: none;"  <?php endif; ?>>
                <div class="form-group">
          ...
          <div class="form-group">
            <div class="multi-input">
              <?php echo Form::label('pay_term_number', __('contact.pay_term') . ':'); ?> <?php
                ...
                ?>
              <br/>
              <?php echo Form::number('pay_term_number', $contact->pay_term_number, ['class' => 'form-control width-60 pull-left', 'placeholder' => __('contact.pay_term')]); ?>


              <?php echo Form::select('pay_term_type', ['months' => __('lang_v1.months'), 'days' => __('lang_v1.days')], $contact->pay_term_type, ['class' => 'form-control select2 width-40 pull-left','placeholder' => __('messages.please_select')]); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/contact/edit.blade.php ENDPATH**/ ?>