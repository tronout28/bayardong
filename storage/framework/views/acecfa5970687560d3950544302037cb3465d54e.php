...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content no-print">
        ...
        <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __( 'lang_v1.all_sales')]); ?>
            ...
            <?php if(auth()->user()->can('installment.view') || auth()->user()->can('direct_sell.access') ||  auth()->user()->can('view_own_sell_only') ||  auth()->user()->can('view_commission_agent_sell')): ?>
                <?php
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/Installment/Providers/../Resources/views/sell/index.blade.php ENDPATH**/ ?>