			...
			<div class="box-tools pull-right">
				<div class="btn-group btn-group-toggle" data-toggle="buttons">
				    <label class="btn btn-info btn-sm active list">
				        <input type="radio" name="project_view" value="list_view" class="project_view" data-href="<?php echo e(action([\Modules\Project\Http\Controllers\ProjectController::class, 'index']).'?project_view=list_view', false); ?>">
				        <?php echo app('translator')->get('project::lang.list_view'); ?>
				    </label>
				    <label class="btn btn-info btn-sm kanban">
				        <input type="radio" name="project_view" value="kanban" class="project_view" data-href="<?php echo e(action([\Modules\Project\Http\Controllers\ProjectController::class, 'index']).'?project_view=kanban', false); ?>">
				...
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project.create_project')): ?>
					<button type="button" class="btn btn-primary btn-sm add_new_project" data-href="<?php echo e(action([\Modules\Project\Http\Controllers\ProjectController::class, 'create']), false); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/Project/Providers/../Resources/views/project/index.blade.php ENDPATH**/ ?>