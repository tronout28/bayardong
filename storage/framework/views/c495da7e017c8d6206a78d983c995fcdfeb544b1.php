	...
	<div class="col-md-3 col-xs-6 order_div">
		<div class="small-box bg-gray">
            ...
            <?php elseif($orders_for == 'waiter' && $order->res_order_status != 'served'): ?>
            	<a href="#" class="btn btn-flat small-box-footer bg-yellow mark_as_served_btn" data-href="<?php echo e(action([\App\Http\Controllers\Restaurant\OrderController::class, 'markAsServed'], [$order->id]), false); ?>"><i class="fa fa-check-square-o"></i> <?php echo app('translator')->get('restaurant.mark_as_served'); ?></a>
            <?php else: ?>
            	<div class="small-box-footer bg-gray">&nbsp;</div>
            <?php endif; ?>
            	<a href="#" class="btn btn-flat small-box-footer bg-info btn-modal" data-href="<?php echo e(action([\App\Http\Controllers\SellController::class, 'show'], [$order->id]), false); ?>" data-container=".view_modal"><?php echo app('translator')->get('restaurant.order_details'); ?> <i class="fa fa-arrow-circle-right"></i></a>
         </div>
	</div>
...
<?php endif; ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/restaurant/partials/show_orders.blade.php ENDPATH**/ ?>