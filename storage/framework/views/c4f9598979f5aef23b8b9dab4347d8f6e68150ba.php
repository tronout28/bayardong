    ...
    <div class="row justify-content-center px-lg-5">
        ...
        <div class="col-lg-4 mx-auto mt-4 mt-xl-0 d-flex flex-row-reverse align-items-center justify-content-center justify-content-lg-start">
            <div class="text-center">
                <a class="btn btn-secondary" href="<?php echo e($cta_btn['link'], false); ?>">
                    <span class="mx-1">
                        <?php echo e($cta_btn['text'], false); ?>
...
</div><?php /**PATH D:\Laravel\bayardong-project\bayardong.com\Modules\Cms\Providers/../Resources/views/frontend/pages/partials/cta.blade.php ENDPATH**/ ?>