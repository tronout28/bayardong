...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"><?php echo app('translator')->get('product.variations'); ?>
            <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold"><?php echo app('translator')->get('lang_v1.manage_product_variations'); ?></small>
        </h1>
        <!-- <ol class="breadcrumb">
        ...
        <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_variations')]); ?>
            <?php $__env->slot('tool'); ?>
                <div class="box-tools">
                    ...
                    data-href="<?php echo e(action([\App\Http\Controllers\VariationTemplateController::class, 'create']), false); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/variation/index.blade.php ENDPATH**/ ?>