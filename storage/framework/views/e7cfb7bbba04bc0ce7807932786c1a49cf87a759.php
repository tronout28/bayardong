...
<section class="content">
    ...
    <div class="row no-print">
        <div class="col-md-3">
            <a href="<?php echo e(action([\App\Http\Controllers\ReportController::class, 'getStockReport']), false); ?>?only_mfg=true" class="btn btn-info btn-flat btn-block"><?php echo app('translator')->get('report.stock_report'); ?></a>
        </div>
        <?php if(session('business.enable_lot_number') == 1): ?>
        <div class="col-md-3">
            <a href="<?php echo e(action([\App\Http\Controllers\ReportController::class, 'getLotReport']), false); ?>?only_mfg=true" class="btn btn-success btn-flat btn-block"><?php echo app('translator')->get('lang_v1.lot_report'); ?></a>
        </div>
        <?php endif; ?>
        <?php if(session('business.enable_product_expiry') == 1): ?>
        <div class="col-md-3">
            <a href="<?php echo e(action([\App\Http\Controllers\ReportController::class, 'getStockExpiryReport']), false); ?>?only_mfg=true" class="btn btn-warning btn-flat btn-block"><?php echo app('translator')->get('report.stock_expiry_report'); ?></a>
        </div>
        <?php endif; ?>
        <div class="col-md-3">
            <a href="<?php echo e(action([\App\Http\Controllers\ReportController::class, 'itemsReport']), false); ?>?only_mfg=true" class="btn btn-danger btn-flat btn-block"><?php echo app('translator')->get('lang_v1.items_report'); ?></a>
        </div>
    </div>
    <br>
    <div class="row no-print">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u7054907/public_html/bayardong.com/Modules/Manufacturing/Providers/../Resources/views/production/report.blade.php ENDPATH**/ ?>