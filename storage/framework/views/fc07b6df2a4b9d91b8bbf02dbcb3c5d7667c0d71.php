...
<tr class="product_row" data-row_index="<?php echo e($row_count, false); ?>" <?php if(!empty($so_line)): ?> data-so_id="<?php echo e($so_line->transaction_id, false); ?>" <?php endif; ?>>
	<td>
		...
		?>
		<img src="<?php if(!empty($product->media) && count($product->media) > 0): ?>
					...
					<?php endif; ?>" alt="Product image" class="product-thumbnail-small" style="float: left; margin-right: 8px;">
	...
	<td>
		...
		<?php if(!empty($sub_units) && count($sub_units) > 0): ?>
			<br>
	...
	<?php if(!empty($is_direct_sell)): ?>
		...
		<td <?php if(!$edit_discount): ?> class="hide" <?php endif; ?>>
			<?php echo Form::select("products[$row_count][line_discount_type]", ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], $discount_type , ['class' => 'form-control row_discount_type']); ?><br>
...
</tr><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/sale_pos/product_row.blade.php ENDPATH**/ ?>