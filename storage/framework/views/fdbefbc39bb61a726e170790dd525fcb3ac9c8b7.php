...
<table class="table table-bordered table-striped" id="sr_sales_report" style="width: 100%;">
    ...
    <tfoot>
        <tr class="bg-gray font-17 footer-total text-center">
            ...
            <td class="text-left"><small><?php echo app('translator')->get('lang_v1.sell_due'); ?> - <span class="display_currency" id="sr_footer_total_remaining" data-currency_symbol ="true"></span><br><?php echo app('translator')->get('lang_v1.sell_return_due'); ?> - <span class="display_currency" id="sr_footer_total_sell_return_due" data-currency_symbol ="true"></span></small></td>
        </tr>
    </tfoot>
</table>
</div><?php /**PATH /home/u7054907/public_html/bayardong.com/resources/views/report/partials/sales_representative_sales.blade.php ENDPATH**/ ?>